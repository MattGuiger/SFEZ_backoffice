...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~apps-apps-module~extra-component-extra-component-module"], {
  ...
  /***/
  function node_modulesCrossventNode_modulesCustomEventIndexJs(module, exports) {
  ...
  function node_modulesNg2Dragula__ivy_ngcc__DistFesm2015Ng2DragulaJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function DrakeFactory() {
      ...
      _classCallCheck2(this, DrakeFactory);
    ...
    var filterEvent = function filterEvent(eventType, filterDragType, projector) {
      return function (input) {
        return input.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (_ref4) {
          var event = _ref4.event,
              name = _ref4.name;
          return event === eventType && (filterDragType === undefined || name === filterDragType);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (_ref5) {
          var name = _ref5.name,
              args = _ref5.args;
    ...
    var elContainerSourceProjector = function elContainerSourceProjector(name, _ref6) {
    ...
    function () {
      ...
      function DragulaService() {
        ...
        _classCallCheck2(this, DragulaService);

        this.drakeFactory = drakeFactory;
        this.dispatch$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();

        this.drag = function (groupName) {
          return _this12.dispatch$.pipe(filterEvent(EventTypes.Drag, groupName, function (name, _ref8) {
        ...
        this.dragend = function (groupName) {
          return _this12.dispatch$.pipe(filterEvent(EventTypes.DragEnd, groupName, function (name, _ref10) {
            var _ref11 = _slicedToArray2(_ref10, 1),
                el = _ref11[0];
        ...
        this.drop = function (groupName) {
          return _this12.dispatch$.pipe(filterEvent(EventTypes.Drop, groupName, function (name, _ref12) {
            var _ref13 = _slicedToArray2(_ref12, 4),
                el = _ref13[0],
                target = _ref13[1],
                source = _ref13[2],
                sibling = _ref13[3];
        ...
        this.elContainerSource = function (eventType) {
          return function (groupName) {
            return _this12.dispatch$.pipe(filterEvent(eventType, groupName, elContainerSourceProjector));
          };
        };
        ...
        this.cloned = function (groupName) {
          return _this12.dispatch$.pipe(filterEvent(EventTypes.Cloned, groupName, function (name, _ref14) {
            var _ref15 = _slicedToArray2(_ref14, 3),
                clone = _ref15[0],
                original = _ref15[1],
                cloneType = _ref15[2];
        ...
        this.dropModel = function (groupName) {
          return _this12.dispatch$.pipe(filterEvent(EventTypes.DropModel, groupName, function (name, _ref16) {
            var _ref17 = _slicedToArray2(_ref16, 9),
                el = _ref17[0],
                target = _ref17[1],
                source = _ref17[2],
                sibling = _ref17[3],
                item = _ref17[4],
                sourceModel = _ref17[5],
                targetModel = _ref17[6],
                sourceIndex = _ref17[7],
                targetIndex = _ref17[8];
        ...
        this.removeModel = function (groupName) {
          return _this12.dispatch$.pipe(filterEvent(EventTypes.RemoveModel, groupName, function (name, _ref18) {
            var _ref19 = _slicedToArray2(_ref18, 6),
                el = _ref19[0],
                container = _ref19[1],
                source = _ref19[2],
                item = _ref19[3],
                sourceModel = _ref19[4],
                sourceIndex = _ref19[5];
      ...
      _createClass2(DragulaService, [{
        ...
        key: "handleModels",
        value: function handleModels(_ref20) {
          var _this13 = this;
          ...
          drake.on('drag', function (el, source) {
            ...
            dragElm = el;
            dragIndex = _this13.domIndexOf(el, source);
          });
          drake.on('drop', function (dropElm, target, source, sibling) {
            ...
            dropIndex = _this13.domIndexOf(dropElm, target);
            /** @type {?} */
    ...
    function () {
      ...
      function DragulaDirective(el, dragulaService) {
        _classCallCheck2(this, DragulaDirective);
      ...
      _createClass2(DragulaDirective, [{
        key: "ngOnChanges",
        ...
        value: function setup() {
          ...
          var checkModel = function checkModel(group) {
            if (_this15.dragulaModel) {
              if (group.drake.models) {
                group.drake.models.push(_this15.dragulaModel);
              } else {
                group.drake.models = [_this15.dragulaModel];
              }
            }
          };
          /** @type {?} */
        ...
        value: function subscribe(name) {
          ...
          this.subs.add(this.dragulaService.dropModel(name).subscribe(function (_ref21) {
            var source = _ref21.source,
                target = _ref21.target,
                sourceModel = _ref21.sourceModel,
                targetModel = _ref21.targetModel;

            if (source === _this16.el.nativeElement) {
              _this16.dragulaModelChange.emit(sourceModel);
            } else if (target === _this16.el.nativeElement) {
              _this16.dragulaModelChange.emit(targetModel);
            }
          }));
          this.subs.add(this.dragulaService.removeModel(name).subscribe(function (_ref22) {
    ...
    function () {
      function DragulaModule() {
        _classCallCheck2(this, DragulaModule);
      }

      _createClass2(DragulaModule, null, [{
        key: "forRoot",
    ...
    function () {
      ...
      function MockDrake() {
        ...
        _classCallCheck2(this, MockDrake);
      ...
      _createClass2(MockDrake, [{
        ...
        value: function on(event, callback) {
          this.subs.add(this.emitter$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (_ref23) {
            var eventType = _ref23.eventType;
            return eventType === event;
          })).subscribe(function (_ref24) {
            var args = _ref24.args;
            callback.apply(void 0, _toConsumableArray2(args));
          }));
        }
        /**
         * @return {?}
  ...
  function node_modulesNgxQuill__ivy_ngcc__Fesm2015NgxQuillJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function QuillEditorComponent(elementRef, domSanitizer, doc, platformId, renderer, zone, config) {
        ...
        this.valueSetter = function (quillEditor, value) {
          ...
          if (format === 'html') {
            if (_this17.sanitize) {
              value = _this17.domSanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_2__["SecurityContext"].HTML, value);
            }
        ...
        this.selectionChangeHandler = function (range, oldRange, source) {
          var shouldTriggerOnModelTouched = !range && _this17.onModelTouched; // only emit changes when there's any listener

          if (!_this17.onBlur.observers.length && !_this17.onFocus.observers.length && !_this17.onSelectionChanged.observers.length && !shouldTriggerOnModelTouched) {
            return;
          }
          ...
          _this17.zone.run(function () {
            if (range === null) {
              _this17.onBlur.emit({
                editor: _this17.quillEditor,
                source: source
              });
            } else if (oldRange === null) {
              _this17.onFocus.emit({
                editor: _this17.quillEditor,
                source: source
              });
            }

            _this17.onSelectionChanged.emit({
              editor: _this17.quillEditor,
              oldRange: oldRange,
              range: range,
              source: source
        ...
        this.textChangeHandler = function (delta, oldDelta, source) {
          ...
          var text = _this17.quillEditor.getText();

          var content = _this17.quillEditor.getContents();

          var html = _this17.editorElem.querySelector('.ql-editor').innerHTML;

          if (html === '<p><br></p>' || html === '<div><br></div>') {
            html = null;
          }

          var trackChanges = _this17.trackChanges || _this17.config.trackChanges;
          var shouldTriggerOnModelChange = (source === Quill.sources.USER || trackChanges && trackChanges === 'all') && _this17.onModelChange; // only emit changes when there's any listener

          if (!_this17.onContentChanged.observers.length && !shouldTriggerOnModelChange) {
            return;
          }

          _this17.zone.run(function () {
            if (shouldTriggerOnModelChange) {
              _this17.onModelChange(_this17.valueGetter(_this17.quillEditor, _this17.editorElem));
            }

            _this17.onContentChanged.emit({
              content: content,
              delta: delta,
              editor: _this17.quillEditor,
              html: html,
        ...
        this.editorChangeHandler = function (event, current, old, source) {
          ...
          if (!_this17.onEditorChanged.observers.length) {
            return;
          } // only emit changes emitted by user interactions
      ...
      _createClass2(QuillEditorComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          if (this.styles) {
            Object.keys(this.styles).forEach(function (key) {
              _this18.renderer.setStyle(_this18.editorElem, key, _this18.styles[key]);
            });
          }
          ...
          this.zone.runOutsideAngular(function () {
            _this18.quillEditor = new Quill(_this18.editorElem, {
              bounds: bounds,
              debug: debug,
              formats: formats,
              modules: modules,
              ...
              theme: _this18.theme || (_this18.config.theme ? _this18.config.theme : 'snow')
            });
          });
          ...
          setTimeout(function () {
            return _this18.onEditorCreated.emit(_this18.quillEditor);
          });
        }
      }, {
        key: "ngOnDestroy",
          ...
          if (changes['styles']) {
            ...
            if (previousStyling) {
              Object.keys(previousStyling).forEach(function (key) {
                _this19.renderer.removeStyle(_this19.editorElem, key);
              });
            }

            if (currentStyling) {
              Object.keys(currentStyling).forEach(function (key) {
                _this19.renderer.setStyle(_this19.editorElem, key, _this19.styles[key]);
              });
            }
          }
        ...
        value: function addClasses(classList) {
          ...
          QuillEditorComponent_1.normalizeClassNames(classList).forEach(function (c) {
            _this20.renderer.addClass(_this20.editorElem, c);
          });
        }
      }, {
        key: "removeClasses",
        value: function removeClasses(classList) {
          ...
          QuillEditorComponent_1.normalizeClassNames(classList).forEach(function (c) {
            _this21.renderer.removeClass(_this21.editorElem, c);
          });
        }
      }, {
        key: "writeValue",
    ...
    function () {
      function QuillViewComponent(platformId, config, renderer, elementRef) {
        ...
        this.valueSetter = function (quillEditor, value) {
          var format = getFormat(_this22.format, _this22.config.format);
          var content = value;
