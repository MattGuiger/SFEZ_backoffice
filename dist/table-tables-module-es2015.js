...
BasictableComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BasictableComponent, selectors: [["ng-component"]], decls: 880, vars: 0, consts: [[1, "row"], [1, "col-12"], [1, "card"], [1, "card-body"], [1, "card-title"], [1, "card-subtitle"], [1, "card-title", "m-t-40"], [1, "m-r-5", "font-18", "mdi", "mdi-numeric-1-box-multiple-outline"], [1, "table-responsive"], [1, "table"], ["scope", "col"], ["scope", "row"], [1, "m-r-5", "font-18", "mdi", "mdi-numeric-2-box-multiple-outline"], [1, "thead-light"], [1, "table", "table-striped"], [1, "table", "table-bordered"], ["colspan", "2"], [1, "table", "table-hover"], [1, "table-active"], [1, "table-primary"], [1, "table-success"], [1, "table-danger"], [1, "table-info"], [1, "table-responsive", "m-t-20"], [1, "table", "table-bordered", "table-responsive-lg"], [1, "table-responsive-sm"], [1, "table-responsive-md"], [1, "table-responsive-lg"], [1, "table-responsive-xl"]], template: function BasictableComponent_Template(rf, ctx) { if (rf & 1) {
