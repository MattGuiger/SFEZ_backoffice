...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["menuitems-menuitems-module"], {
  ...
  function srcAppMenuitemsMenuitemsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MenuitemsComponent_ng_template_16_mat_tab_6_ng_container_8_ng_container_33_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MenuitemsComponent_ng_template_16_mat_tab_6_ng_container_8_ng_container_33_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function () {
      ...
      _createClass(MenuitemsComponent, [{
        ...
        key: "onFileSelectget",
        value: function onFileSelectget(event, fileName) {
          if (event.target.files.length > 0) {
            var file = event.target.files[0];
            this.fileget = file;
            fileName.user_id = file.name;
